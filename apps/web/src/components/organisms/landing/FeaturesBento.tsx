  ...
  return (
    <section className="py-28 px-6 max-w-5xl mx-auto">
      <div className="text-center mb-16">
        <div className="inline-flex px-3 py-1 rounded-full border border-[#594EE6]/30 bg-[#594EE6]/10 text-[11px] font-medium text-[#847BFF] mb-6">
          Protocol Features
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
        ...
        <div className="md:col-span-4 rounded-2xl border border-white/5 bg-gradient-to-b from-[#141418] to-[#0A0A0C] p-6 relative overflow-hidden group">
          <div className="absolute inset-0 bg-[#594EE6]/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
          {/* Visual */}
          <div className="h-32 mb-6 flex items-center justify-center relative">
            <div className="w-full max-w-[200px] h-14 bg-[#1C1C22] rounded-xl border border-white/5 shadow-xl flex items-center px-4 gap-3 z-10">
              <div className="w-8 h-8 rounded-full bg-[#594EE6] flex items-center justify-center text-[10px] font-bold">RH</div>
              <div>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150px] h-[100px] bg-[#594EE6]/30 blur-[40px]"></div>
          </div>
          <div>
        ...
        <div className="md:col-span-8 rounded-2xl border border-white/5 bg-gradient-to-b from-[#141418] to-[#0A0A0C] p-6 relative overflow-hidden group flex flex-col md:flex-row gap-6">
          <div className="absolute bottom-0 right-0 w-[400px] h-[150px] bg-[#594EE6]/20 blur-[60px] opacity-0 group-hover:opacity-100 transition-opacity"></div>
          ...
          <div className="flex-1 flex flex-col gap-3 justify-center items-end pr-4 relative">
             <div className="w-[80%] h-10 rounded-lg border border-white/10 bg-white/5 flex items-center px-3 justify-between">
             ...
             <div className="w-full h-10 rounded-lg border border-[#594EE6]/40 bg-[#594EE6]/10 flex items-center px-3 justify-between relative shadow-[0_0_15px_rgba(89,78,230,0.2)]">
               <div className="flex items-center gap-2">
                 <div className="w-4 h-4 border border-[#594EE6]/50 rounded-sm bg-[#594EE6]/20"></div>
                 <span className="text-[11px] text-[#A69FFF] font-medium">BTC Hits $100k</span>
               </div>
               <div className="w-8 h-5 rounded bg-[#594EE6] text-white flex items-center justify-center text-[10px] shadow-sm shadow-[#594EE6]">89%</div>
               {/* Mouse Cursor */}
        ...
        <div className="md:col-span-6 rounded-2xl border border-white/5 bg-gradient-to-b from-[#141418] to-[#0A0A0C] p-6 relative overflow-hidden group">
          {/* Visual area */}
          <div className="h-40 mb-6 bg-black/40 rounded-xl border border-white/5 relative overflow-hidden p-4 flex flex-col items-center justify-center">
             ...
             <div className="flex gap-2 mb-4 w-full px-6">
               ...
               <div className="flex-1 py-2 rounded border border-[#594EE6]/40 bg-[#594EE6]/10 text-[10px] text-center text-white font-medium shadow-[0_0_10px_rgba(89,78,230,0.2)]">61%</div>
             ...
             <div className="absolute bottom-0 w-full h-[60px] bg-gradient-to-t from-[#594EE6]/20 to-transparent blur-[20px]"></div>
          </div>
        ...
        <div className="md:col-span-6 rounded-2xl border border-white/5 bg-gradient-to-b from-[#141418] to-[#0A0A0C] p-6 relative overflow-hidden group flex flex-col justify-end">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-[150px] bg-[#594EE6]/10 blur-[50px]"></div>
          
          <div className="absolute top-8 left-8 right-8 flex flex-col gap-4">
            <div className="self-end bg-[#594EE6] text-white text-[10px] px-3 py-2 rounded-lg rounded-tr-none max-w-[200px] shadow-lg">
              Redeem winning shares instantly
              <div className="text-[7px] text-white/70 mt-1 uppercase opacity-60">Step 2</div>
            </div>
            <div className="self-start bg-[#23232C] border border-white/5 text-white/80 text-[10px] px-3 py-2 rounded-lg rounded-tl-none max-w-[200px] shadow-lg">
              <div className="text-[7px] text-[#594EE6] font-bold mb-1 uppercase">Step 1</div>
